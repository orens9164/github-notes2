...
## Commit
a save file, of sorts. you can add notes to keep track of what point in coding you were in when you made that commit, as well as go back to previous commits. each commit has a unique identifier associated with it.
